      ...
      if (isOpenAI) {
        ...
        return {
          ...
          final_story: {
            ...
            description:
              "As a registered user, I want to securely log in using my email and password so that I can access my personalized dashboard. (Model note: Generated by OpenAI GPT-5 — optimized for clarity and structure.)",
            acceptance_criteria: [
        ...
        return {
          ...
          final_story: {
            ...
            description:
              "As a user, I want to authenticate with my credentials so that my account remains protected and I can access features. (Model note: Generated by Gemini 2.5 Flash — balanced speed and quality.)",
            acceptance_criteria: [
        ...
        return {
          ...
          model_id: modelId,
          final_story: {
            title: "Generic User Story",
            description:
              "As a user, I want this feature implemented so that I can accomplish my goal. (Model note: Unknown model fallback.)",
            acceptance_criteria: [
